...
import john.blog.social.jdbc.NoRankJdbcConnectionRepository;
 ...
 * @author Keith Donald
 */
public class NoRankJdbcUsersConnectionRepository implements UsersConnectionRepository {
    ...
    public NoRankJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        ...
        return new NoRankJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
    }
